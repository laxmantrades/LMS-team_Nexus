...
export default function SidebarStaff() {
  ...
  <div className="md:hidden flex items-center justify-between p-3 bg-slate-900 border-b border-slate-800 shadow-sm text-slate-100">
    <div className="flex items-center gap-3">
      
      <button
        onClick={() => setMobileOpen(true)}
        aria-label="Open menu"
        className="p-2 rounded-md hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-offset-2 focus:ring-offset-slate-900"
      >
        <svg
      ...
      <div className="text-lg font-semibold text-slate-100">Staff</div>
    </div>
    ...
    <div>
      ...
      >
        <svg
          className={`w-5 h-5 text-slate-100 transition-transform ${
        ...
        >
          <path
            fill="currentColor"
            d="M12 5l8 8-8 8-1.4-1.4L17.2 13 10.6 6.4z"
          />
        </svg>
      </button>
    </div>
  ...
  <aside
    className={`hidden md:flex flex-col sticky top-6 h-[calc(100dvh-4.5rem)] bg-slate-900/90 border border-slate-800 rounded-lg shadow p-2 transition-all duration-200 text-slate-100
      ${collapsed ? "w-16" : "w-64"}`}
  ...
  >
    ...
    <div className="flex items-center justify-between mb-3 px-1">
      <div className="flex items-center gap-2">
        <div className="text-indigo-300 bg-indigo-900/50 rounded-full w-9 h-9 flex items-center justify-center">
          <svg
            className="w-5 h-5"
            viewBox="0 0 24 24"
            fill="currentColor"
      ...
      <button
        ...
        className="p-1 rounded hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-offset-2 focus:ring-offset-slate-900"
      >
        <svg
    ...
    <div className="mb-8 border-t border-slate-800 pt-3">
      {!collapsed ? (
        <>
          
          <div className="mt-3 px-2">
            <button
              className="w-full text-sm px-3 py-2 rounded-md border border-slate-600 text-slate-100 hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-offset-2 focus:ring-offset-slate-900"
  ...
  {mobileOpen && (
    ...
    >
      ...
      />
      <div className="absolute left-0 top-0 bottom-0 w-72 bg-slate-900 text-slate-100 p-4 shadow-lg overflow-auto">
        ...
        <div className="mt-6">
          <button
            className="w-full text-sm px-3 py-2 rounded-md border border-slate-600 text-slate-100 hover:bg-slate-800"
            onClick={() => {
              setMobileOpen(false);
              handleLogout();
            }}
